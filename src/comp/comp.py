...
c = [i.name for i in humans if i.name[0] == "C" or i.name[0] == "G"]
print(c)
...
f = [f"({i.name},{i.age})" for i in humans if i.age <= 32 and i.age >= 27]

# for i in humans:
#     if i.age <= 32 and i.age >= 27:
